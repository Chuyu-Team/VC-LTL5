...
#if WindowsTargetPlatformMinVersion < WindowsTargetPlatformWindows10_10240 && (defined _AMD64_ || defined _ARM_ || defined _ARM64_)
...
_LCRT_DEFINE_IAT_SYMBOL(__CxxExceptionFilter);
#endif
...
_LCRT_DEFINE_IAT_SYMBOL(__CxxRegisterExceptionObject);
#endif
...
_LCRT_DEFINE_IAT_SYMBOL(__CxxDetectRethrow);
#endif
...
_LCRT_DEFINE_IAT_SYMBOL(__CxxUnregisterExceptionObject);
#endif
...
_LCRT_DEFINE_IAT_SYMBOL(__CxxQueryExceptionSize);
#endif