...
if(${SupportLTL} STREQUAL "true")
	...
	elseif(DEFINED ENV{VSCMD_ARG_TGT_ARCH})
		...
		string(TOLOWER "${VSCMD_ARG_TGT_ARCH}" VSCMD_ARG_TGT_ARCH_LOWER)
		if($ENV{VSCMD_ARG_TGT_ARCH_LOWER} STREQUAL "x86")
			set(LTLPlatform "Win32")
		elseif($ENV{VSCMD_ARG_TGT_ARCH_LOWER} STREQUAL "x64")
			set(LTLPlatform "x64")
		elseif($ENV{VSCMD_ARG_TGT_ARCH_LOWER} STREQUAL "arm")
			set(LTLPlatform "arm")
		elseif($ENV{VSCMD_ARG_TGT_ARCH_LOWER} STREQUAL "arm64")
			set(LTLPlatform "arm64")
		else()
			message(WARNING "VC-LTL not load, Unknown Platform!!!")
			set(SupportLTL "false")
