...
set ERROR_VC_LTL_NOT_SUPPORT_PLATFORM_TOOLSET=VC-LTL仅支持VS 2015、2017、2019以及2022。

set ERROR_VC_LTL_NOT_SUPPORT_PLATFORM=VC-LTL CMD脚本不支持体系 : %Platform%

set ERROR_VC_LTL_FILE_MISSING=VC-LTL不找不到lib文件，请从 https://github.com/Chuyu-Team/VC-LTL5/releases/latest 下载完整二进制文件然后继续。
